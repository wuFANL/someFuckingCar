    ...
    [[QLOSSManager shared] syncUploadImages:self.imgsArr complete:^(NSArray *names, UploadImageState state) {
        ...
        [[QLOSSManager shared] syncUploadImages:self.imgsArr1 complete:^(NSArray *names, UploadImageState state) {
            ...
            NSDictionary* para = @{
                ...
                @"sell_price":weakSelf.value5?@([weakSelf.value5 floatValue]*1000):@"",
                @"sell_min_price":weakSelf.value6?@([weakSelf.value6 floatValue]*1000):@"",
                @"wholesale_price":weakSelf.value7?@([weakSelf.value7 floatValue]*1000):@"",
                @"procure_price":weakSelf.value8?@([weakSelf.value8 floatValue]*1000):@"",
